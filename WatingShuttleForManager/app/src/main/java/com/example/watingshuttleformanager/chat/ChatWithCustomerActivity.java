...
public class ChatWithCustomerActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null){
            ...
            chatRoom=(ChatRoom) bundle.getParcelable(KEY_SIMPLE_DATA);
...
//채팅 바로 접속 test
        ...
        mAdapter = new ChatListAdapter(ChatWithCustomerActivity.this, chatList);
        ...
        mMainHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (m != null)
                    Toast.makeText(ChatWithCustomerActivity.this, m, Toast.LENGTH_SHORT).show();
...
///test
                if(client!=null){
                    ...
                    JSONObject json_string=new JSONObject();
                    try{
                        int roomnumber=chatRoom.getRoom_number();

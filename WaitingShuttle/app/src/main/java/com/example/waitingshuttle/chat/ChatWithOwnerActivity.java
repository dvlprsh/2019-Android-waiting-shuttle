package com.example.waitingshuttle.chat;
...
//채팅 바로 접속 test
        ...
        mAdapter = new ChatListAdapter(ChatWithOwnerActivity.this, chatList);
        ...
        mMainHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (m != null)
                    Toast.makeText(ChatWithOwnerActivity.this, m, Toast.LENGTH_SHORT).show();
...
//converting the string to json array object
                        ...
                        RequestQueue queue = Volley.newRequestQueue(ChatWithOwnerActivity.this);
...
///test
                if(client!=null){
                    ...
                    try{
                        ...
                        json_string.put("roomnumber", roomnumber); //채팅방 나누기
